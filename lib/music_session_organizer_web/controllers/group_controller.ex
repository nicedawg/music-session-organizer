defmodule MusicSessionOrganizerWeb.GroupController do
  use MusicSessionOrganizerWeb, :controller

  alias MusicSessionOrganizer.Groups
  alias MusicSessionOrganizer.Groups.Group

  action_fallback MusicSessionOrganizerWeb.FallbackController
